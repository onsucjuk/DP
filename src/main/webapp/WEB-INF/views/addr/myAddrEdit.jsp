...
<form name="f" id="f">
        ...
        <div class="divTableBody">
            <div class="divTableRow">
                ...
                <div class="divTableCell">
                    <textarea name="addr" style="width: 95%; height: 400px" ><%=CmmUtil.nvl(rDTO.getAddr())%></textarea>
                </div>
            </div>
            <div class="divTableRow">
                ...
                <div class="divTableCell">
                    <textarea name="memo" style="width: 95%; height: 400px" ><%=CmmUtil.nvl(rDTO.getMemo())%></textarea>
                </div>
            </div>
        </div>
    </div>
    <div>
        ...
        <button id="btnmyAddrList" type="button">즐겨찾기 리스트로</button>
    </div>
</form>
</body>
</html>